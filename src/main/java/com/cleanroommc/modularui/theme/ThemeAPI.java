...
public class ThemeAPI implements IThemeApi {
    ...
    private ThemeAPI() {
        registerWidgetTheme(Theme.PANEL, new WidgetTheme(GuiTextures.BACKGROUND, null, Color.WHITE.main, 0xFF404040, false), WidgetTheme::new);
        registerWidgetTheme(Theme.BUTTON, new WidgetTheme(GuiTextures.BUTTON, null, Color.WHITE.main, Color.WHITE.main, true), WidgetTheme::new);
        registerWidgetTheme(Theme.ITEM_SLOT, new WidgetSlotTheme(GuiTextures.SLOT, Color.withAlpha(Color.WHITE.main, 0x60)), WidgetSlotTheme::new);
        registerWidgetTheme(Theme.FLUID_SLOT, new WidgetSlotTheme(GuiTextures.SLOT_DARK, Color.withAlpha(Color.WHITE.main, 0x60)), WidgetSlotTheme::new);
        ...
        registerWidgetTheme(Theme.TOGGLE_BUTTON, new WidgetToggleButtonTheme(GuiTextures.BUTTON, null, Color.WHITE.main, Color.WHITE.main, true, GuiTextures.SLOT, null, 0xFFBBBBBB), WidgetToggleButtonTheme::new);
    }
