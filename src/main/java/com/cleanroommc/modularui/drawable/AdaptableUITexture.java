...
public class AdaptableUITexture extends UITexture {
    ...
    public void drawTiled(float x, float y, float width, float height) {
        ...
        if ((this.bl > 0 || this.br > 0) && this.bt <= 0 && this.bb <= 0) {
            // left border
            GuiDraw.drawTiledTexture(x, y, this.bl, height, this.u0, this.v0, this.u0 + uBl, this.v1, this.bl, this.imageHeight, 0);
            // right border
            GuiDraw.drawTiledTexture(x1 - this.br, y, this.br, height, this.u1 - uBr, this.v0, this.u1, this.v1, this.br, this.imageHeight, 0);
            // center
            GuiDraw.drawTiledTexture(x + this.bl, y, width - this.bl - this.br, height, uBl, this.v0, this.u1 - uBr, this.v1, this.imageHeight - this.bl - this.br, this.imageHeight, 0);
        } else if (this.bl <= 0 && this.br <= 0) {
            // top border
            GuiDraw.drawTiledTexture(x, y, width, this.bt, this.u0, this.v0, this.u1, this.v0 + vBt, this.imageWidth, this.bt, 0);
            // bottom border
            GuiDraw.drawTiledTexture(x, y1 - this.bb, width, this.bb, this.u0, this.v1 - vBb, this.u1, this.v1, this.imageWidth, this.bb, 0);
            // center
            GuiDraw.drawTiledTexture(x, y + this.bt, width, height - this.bt - this.bb, this.u0, vBt, this.u1, this.v1 - vBb, this.imageWidth, this.imageHeight - this.bt - this.bb, 0);
        } else {
            // top left corner
            ...
            // left border
            GuiDraw.drawTiledTexture(x, y + this.bt, this.bl, height - this.bt - this.bb, this.u0, vBt, uBl, this.v1 - vBb, this.bl, this.imageHeight - this.bt - this.bb, 0);
            // top border
            GuiDraw.drawTiledTexture(x + this.bl, y, width - this.bl  - this.br, this.bt, uBl, this.v0, this.u1 - uBr, vBt, this.imageWidth - this.bl - this.bb, this.bt, 0);
            // right border
            GuiDraw.drawTiledTexture(x1 - this.br, y + this.bt, this.br, height - this.bt - this.bb, this.u1 - uBr, vBt, this.u1, this.v1 - vBb, this.br, this.imageHeight - this.bt - this.bb, 0);
            // bottom border
            GuiDraw.drawTiledTexture(x + this.bl, y1 - this.bb, width - this.bl - this.br, this.bb, uBl, this.v1 - vBb, this.u1 - uBr, this.v1, this.imageWidth - this.bl - this.br, this.bb, 0);

            // center
            GuiDraw.drawTiledTexture(x + this.bl, y + this.bt, width - this.bl - this.br, height - this.bt - this.bb, uBl, vBt, this.u1 - uBr, this.v1 - vBb, this.imageWidth - this.bl - this.br, this.imageHeight - this.bt - this.bb, 0);
        }
        GlStateManager.disableBlend();
        GlStateManager.enableAlpha();
    }
