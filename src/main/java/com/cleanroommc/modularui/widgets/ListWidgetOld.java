...
public class ListWidgetOld<T, I extends IWidget, W extends ListWidgetOld<T, I, W>> extends ScrollWidget<W> implements ILayoutWidget {
    ...
    public ListWidgetOld() {
        this(v -> null, w -> null);
    }

    public ListWidgetOld(Collection<IWidget> widgets) {
        this();
    ...
    public ListWidgetOld(Function<T, I> valueToWidgetMapper, Function<I, T> widgetToValueMapper) {
    ...
    public static <T, V extends IValueWidget<T> & IWidget, W extends ListWidgetOld<T, V, W>> ListWidgetOld<T, V, W> of(Function<T, V> valueToWidgetMapper) {
        return new ListWidgetOld<>(valueToWidgetMapper, IValueWidget::getWidgetValue);
    }

    public static <T, I extends IWidget, W extends ListWidgetOld<T, I, W>> ListWidgetOld<T, I, W> builder(Iterable<T> iterable, Function<T, I> creator) {
        Map<T, I> map = new Object2ObjectOpenHashMap<>();
        Map<I, T> map_reverse = new Object2ObjectOpenHashMap<>();
        ListWidgetOld<T, I, W> listWidget = new ListWidgetOld<>(map::get, map_reverse::get);
        for (T t : iterable) {
