...
public class StringTextFieldWidget extends TextFieldWidget<StringTextFieldWidget> {
    ...
    public StringTextFieldWidget value(IStringValue<?> value) {
        this.stringValue = value;
        setValue(value);
        return this;
    }

    public StringTextFieldWidget setValidator(Function<String, String> validator) {
