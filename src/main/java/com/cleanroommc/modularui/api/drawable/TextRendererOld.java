...
public class TextRendererOld {
    ...
    public static void drawString(String text, Pos2d pos, int color, int maxWidth) {
        TextRendererOld renderer = new TextRendererOld(pos, color, maxWidth);
        renderer.draw(text);
    }
    ...
    public TextRendererOld(Pos2d pos, int color, float maxWidth) {
        this(pos.x, pos.y, color, maxWidth);
    }

    public TextRendererOld(float x, float y, int color, float maxWidth) {
